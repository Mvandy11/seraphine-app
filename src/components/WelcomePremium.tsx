...
const WelcomePremium: React.FC<WelcomePremiumProps> = ({ onContinue }) => {
  ...
  if (!isSubscribed) {
    return (
      <div style={styles.container}>
        <h2 style={styles.heading}>You haven't unlocked Premium yet</h2>
        <p style={styles.subText}>
          Subscribe to access the full mythic experience.
        </p>
        {onContinue && (
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.tierBadge}>
        ...
        <span style={styles.tierLabel}>{planLabel} Tier</span>
      </div>
      {renewalDate && (
        <p style={styles.renewalText}>Renews on {renewalDate}</p>
      )}
