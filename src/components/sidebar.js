...
const sidebarVariants = cva("h-full bg-background/80 backdrop-blur-sm border-r border-border/40 shadow-sm", {
    variants: {
        size: {
            sm: "w-16",
            md: "w-64",
...
const Sidebar = React.forwardRef(({ className, size, collapsible, collapsed = false, children, ...props }, ref) => {
    const actualSize = collapsed ? "sm" : size;
    return (_jsx("div", { ref: ref, className: cn(sidebarVariants({ size: actualSize, collapsible }), className), ...props, children: children }));
});
Sidebar.displayName = "Sidebar";
const SidebarHeader = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("p-4 border-b border-border/40", className), ...props })));
SidebarHeader.displayName = "SidebarHeader";
const SidebarFooter = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("p-4 border-t border-border/40 mt-auto", className), ...props })));
SidebarFooter.displayName = "SidebarFooter";
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("flex flex-col flex-1 p-2", className), ...props })));
SidebarContent.displayName = "SidebarContent";
const SidebarNav = React.forwardRef(({ className, ...props }, ref) => (_jsx("nav", { ref: ref, className: cn("flex flex-col gap-1", className), ...props })));
SidebarNav.displayName = "SidebarNav";
const SidebarNavItem = React.forwardRef(({ className, active, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("flex items-center px-3 py-2 rounded-md text-sm text-foreground/80 hover:text-foreground hover:bg-accent/50 transition-colors cursor-pointer", active && "bg-accent/60 text-primary font-medium", className), ...props })));
SidebarNavItem.displayName = "SidebarNavItem";
const SidebarSection = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("mb-2", className), ...props })));
SidebarSection.displayName = "SidebarSection";
const SidebarSectionTitle = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { ref: ref, className: cn("text-xs uppercase font-medium text-muted-foreground/70 tracking-wider px-3 py-1", className), ...props })));
...
export { Sidebar, SidebarContent, SidebarFooter, SidebarGroup, SidebarGroupAction, SidebarGroupContent, SidebarGroupLabel, SidebarHeader, SidebarInput, SidebarInset, SidebarMenu, SidebarMenuAction, SidebarMenuBadge, SidebarMenuButton, SidebarMenuItem, SidebarMenuSkeleton, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, SidebarProvider, SidebarRail, SidebarSeparator, SidebarTrigger, useSidebar, SidebarNav, SidebarNavItem, SidebarSection, SidebarSectionTitle };
